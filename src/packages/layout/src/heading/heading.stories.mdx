...
import { EActionModule, EButtonModule, EBreadcrumbsModule } from '../../../core';
import { EHeading, EHeadingModule } from './';

# Heading

<Meta title="Layout/Heading" decorators={[moduleMetadata({ imports: [EHeadingModule, RouterModule.forRoot([], { useHash: true }), EActionModule, EButtonModule, EBreadcrumbsModule] })]} />
        ...
        {{
            template: `
                <e-heading [title]="title">
                    ...
                    <div heading-actions>
                        <button eButton appearance="primary">Primary action</button>
                    </div>
                </e-heading>
            `,
            props: {
...
<Preview>
    <Story name="breadcrumbs" height="150px">
        {{
            template: `
                <e-heading [title]="title">
                    <e-breadcrumbs>
                        <a eBreadcrumbItem>Section</a>
                    </e-breadcrumbs>
                    <div heading-actions>
                        <button eButton appearance="primary">Primary action</button>
                        <button eButton appearance="secondary">Secondary action</button>
                    </div>
                </e-heading>
            `,
            props: {
